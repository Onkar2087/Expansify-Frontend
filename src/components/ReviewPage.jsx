...
function ReviewPage() {
  ...
  return (
    <div className='flex items-center justify-center flex-col'>
      <h1 className='text-3xl font-semibold text-center mt-[30px] px-[20px]'>Real Reviews from Real Learners</h1>
      <span className='lg:w-[50%] md:w-[80%] text-xl text-center mt-[30px] mb-[30px] px-[20px]'>Discover how Expansify is transforming learning experiences through real feedback from students and professionals worldwide.</span>
