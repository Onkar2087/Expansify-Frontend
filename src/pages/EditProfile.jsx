      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative">
        ...
        <form  className="space-y-5" onSubmit={(e)=>e.preventDefault()}>
         ...
         {userData?.name.slice(0,1).toUpperCase()}
          ...
          <div>
            <label htmlFor='image' className="text-sm font-medium text-gray-700 cursor-pointer">Select Avatar</label>
            <input
            id='image'
              type="file"
              name="photoUrl"
              ...
              className="w-full px-4  cursor-pointer py-2 border rounded-md text-sm "
          ...
          <div>
            ...
            <input
              ...
              readOnly
              className="w-full mt-1 px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-600 placeholder:text-black disabled"
          ...
          {/* Description */}
          <div>
            <label className="text-sm font-medium text-gray-700 cursor-pointer" htmlFor='description'>Description</label>
            <textarea
              name="description"
              id='description'
              className="cursor-pointer w-full mt-1 px-4 py-2 border border-gray-300 rounded-md resize-none focus:ring-2 focus:ring-[black]"
              rows={3}
          ...
          <button
            type="submit"
            className="hover:bg-[#474448] w-full bg-[black] active:bg-[#454545] text-white py-2 rounded-md font-medium transition cursor-pointer" disabled={loading} onClick={updateProfile}
          >
